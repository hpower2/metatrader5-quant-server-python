...
# The Mono install creates the Wine prefix; avoid forcing another init pass here
# because it can hang and block the remaining setup scripts.
log_message "INFO" "Wine prefix prepared."
